...
class ProductController extends Controller
{
    ...
    ->select('products.title', 'products.description', 'variant_one.variant as variant_one', 'variant_two.variant as variant_two', 'variant_three.variant as variant_three', 'product_variant_prices.price', 'product_variant_prices.stock','products.created_at')->paginate(10);;
